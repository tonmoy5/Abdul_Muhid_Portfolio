    ...
    return (
        <div className="w-full">
            <div className="container mx-auto">
                ...
                <div className="mt-10">
                    <h2 className="text-6xl text-center">My Certifications</h2>
                    <div className="flex flex-col md:flex-row justify-evenly items-center mt-10">
                        ...
                        <div className="certification-card">
                            <div className="certification-card-inner">
                                <img src={c2} alt="Certificate 2" className="object-contain h-96 w-96" />
                ...
                {/* Services Section */}
                <div className="mt-10">
                    <h2 className="text-6xl text-center">Services</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10">
                        {services.map((service, index) => (
                            <div key={index} className="service-card bg-white rounded-lg shadow p-6 flex items-center hover:bg-gray-100">
